...
fd_Sides = freeDrinksSidesOnly(sm,pStochastic,allowRepeats,constantRewards); % Press L or R levers for reward

fd_Alt = freeDrinksAlternate(sm,pStochastic,allowRepeats,constantRewards); % Press L,R, or C (alternating) for reward
