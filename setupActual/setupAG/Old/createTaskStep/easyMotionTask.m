function [ts_Motion] = easyMotionTask(svnRev,svnCheckMode,subj)

percentCorrectionTrials = 0.5;

out = getStepDetails(subj);
afc_MotionOpt = coherentDots(out.screen_width,out.screen_height,out.num_dots,...  
    out.coherence,out.speed,out.contrast,out.dot_size,...  
    out.movie_duration,out.screen_zoom,out.maxWidth,out.maxHeight,percentCorrectionTrials);
...
ts_Motion = trainingStep(tm, afc_MotionOpt, crit, sch, svnRev, svnCheckMode,'MotionOpt');
