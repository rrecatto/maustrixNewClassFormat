function [ts_ctrXsfSweep] = createSpecialOrientationSteps(svnRev,svnCheckMode,subj)
...
ts_ctrXsfSweep = trainingStep(tm, afc_ctrXsfSweep, crit, sch, svnRev, svnCheckMode,'orctrXsfSweep');
end
