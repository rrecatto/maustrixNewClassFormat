function [ts_obj_with_req, ts_obj, ts_obj2]=createObjectTrialSteps_autoHuman(svnRev,svnCheckMode)
...
thresholdForResponseWithRequestReward = ratePerDayCriterion(10,1); % make sure animals do 250 per day for a couple of days
thresholdPC=performanceCriterion(0.8,int16(20)); % average of 80% correct for the past 200 trials
...
numTrialsCrit = numTrialsDoneCriterion(64); % 64 trials = 8 conditions * 8 trials/condition
