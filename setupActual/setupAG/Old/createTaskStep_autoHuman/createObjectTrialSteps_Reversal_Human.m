function [ts1, ts2]=createObjectTrialSteps_Reversal_Human(svnRev,svnCheckMode)
...
thresholdPC=performanceCriterionLatestStreak(0.8,int16(20)); % average of 80% correct for the past 200 trials
