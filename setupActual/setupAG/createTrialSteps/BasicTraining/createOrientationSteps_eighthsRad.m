function [ts_optim ts_sfSweep ts_tfSweep ts_ctrSweep ts_orSweep] = createOrientationSteps_eighthsRad(svnRev,svnCheckMode,subj)
...
ts_optim = trainingStep(tm, afc_optim, impossPC, sch, svnRev, svnCheckMode,'orOptimal_eighthsRad');
ts_sfSweep = trainingStep(tm, afc_sfSweep, impossPC, sch, svnRev, svnCheckMode,'orSFSweep_eighthsRad');
ts_tfSweep = trainingStep(tm, afc_tfSweep, impossPC, sch, svnRev, svnCheckMode,'orTFSweep_eighthsRad');
ts_ctrSweep = trainingStep(tm, afc_ctrSweep, impossPC, sch, svnRev, svnCheckMode,'orCTRSweep_eighthsRad');
ts_orSweep = trainingStep(tm, afc_orSweep, impossPC, sch, svnRev, svnCheckMode,'orORSweep_eighthsRad');
end
