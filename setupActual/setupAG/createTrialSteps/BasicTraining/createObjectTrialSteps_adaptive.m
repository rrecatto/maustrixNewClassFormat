function [ts_obj_with_req, ts_obj, ts_obj2]=createObjectTrialSteps_adaptive(svnRev,svnCheckMode,subID)
...
thresholdForResponseWithRequestReward = performanceCriterionLatestStreak(0.8,int16(10)); % make sure animals do 250 per day for a couple of days
...
adaptationMethod.frequency = 5;
adaptationMethod.checkEveryType = 'trials';
adaptationMethod.stepSizeScalar = 0.05;
adaptationMethod.stepSizePenalty = 10000;

adaptiveRewards=adaptiveReinforcement(rewardSizeULorMS,requestRewardSizeULorMS,requestMode,msPenalty,fractionOpenTimeSoundIsOn,fractionPenaltySoundIsOn,scalar,msAirpuff,minRewardScalar,minPenaltyMS,maxPenaltyMS,adaptationMethod,targetTrialRate,targetPctCorrect);
