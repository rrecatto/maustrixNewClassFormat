function [stochdrink, freedrink]=createFreeDrinksStepsAG_autoRec(svnRev,svnCheckMode,subID)
...
runForNDays=numDaysCriterion(3); %Run for a minimum of 5 days
goodTrialRateForNDays = ratePerDayCriterion(125,2); % perform minimum of 125 trials for three consecutive days to graduate...
