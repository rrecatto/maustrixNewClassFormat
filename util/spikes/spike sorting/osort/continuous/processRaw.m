...
for i=startWithBlock:runs
    ...
    %load data from file
    t1=clock;
    [timestampsRaw,dataSamplesRaw] = getRawData( filename, fromInd, tillInd, params.rawFileVersion );
    ...
    if params.doGroundNormalization==1
        ...
        [ commonGround ] = computeNormalizedGround(params.pathRaw, params.normalizationChannels, fromInd, tillInd);
