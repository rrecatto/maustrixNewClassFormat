function out = mouse37(filters,plotOn,trialNumCutoff)
out = [];
...
location1 = 'C:\Users\ephys-data\Desktop\Compiled\Box2\37.compiledTrialRecords.1-6723.mat'; %images,optimal
location2 = 'C:\Users\ephys-data\Desktop\Compiled\Box1\37.compiledTrialRecords.1-9679.mat'; %orOptimal, TF, OR, SF 
...
opt1 = filterBehaviorData(data2,'tsName','orOptimal_nAFC');%2791 trials
...
if analyzeCtr
ctr1 = filterBehaviorData(data2,'tsName','orCTRSweep');%2946 trials 
...
%% SPAT FREQ
if analyzeSF
spat = filterBehaviorData(data2,'tsName','orSFSweep');%1x1072 trials 
