function out = mouse22(filters,plotOn,trialNumCutoff)
out = [];
...
daysIntact = {'24-Jul-2012','25-Jul-2012','26-Jul-2012','27-Jul-2012','30-Jul-2012','31-Jul-2012','01-Aug-2012','02-Aug-2012','03-Aug-2012','06-Aug-2012','07-Aug-2012',...
    ...
    '17-Dec-2012','18-Dec-2012','19-Dec-2012','20-Dec-2012','21-Dec-2012','05-Jan-2013','07-Jan-2013','03-Dec-2012','10-Dec-2012','08-Jan-2013','09-Jan-2013','10-Jan-2013',...
    '11-Jan-2013','12-Jan-2013','14-Jan-2013','15-Jan-2013','16-Jan-2013','17-Jan-2013'};
daysLesion = {'28-Jan-2013','29-Jan-2013','30-Jan-2013','31-Jan-2013','01-Feb-2013','04-Feb-2013','05-Feb-2013','06-Feb-2013','07-Feb-2013','08-Feb-2013','10-Feb-2013',...
    '11-Feb-2013','12-Feb-2013','13-Feb-2013','14-Feb-2013','15-Feb-2013','17-Feb-2013','18-Feb-2013','19-Feb-2013','20-Feb-2013','21-Feb-2013','22-Feb-2013','24-Feb-2013',...
    '25-Feb-2013','26-Feb-2013','27-Feb-2013','28-Feb-2013','01-Mar-2013','04-Mar-2013','05-Mar-2013','06-Mar-2013','07-Mar-2013','08-Mar-2013','09-Mar-2013','10-Mar-2013',...
    '11-Mar-2013','12-Mar-2013','13-Mar-2013','14-Mar-2013'};

location1 = 'C:\Users\ephys-data\Desktop\Compiled\Box1\22.compiledTrialRecords.1-15136.mat'; % orOptimal_nAFC,orORSweep,orCTRSweep,orSFSweep
location2 = 'C:\Users\ephys-data\Desktop\Compiled\Box2\22.compiledTrialRecords.1-8228.mat'; %nAFC_images,orSFSweep,orTFSweep,orCTRSweep,orORSweep
...
%% IMAGES
im = filterBehaviorData(data2,'tsName','nAFC_images');%2 trials OLD images is missing????
...
opt2 = filterBehaviorData(data2,'tsName','orOptimal_nAFC');%1430 trials
...
optData.responseTime = [opt1.compiledTrialRecords.responseTime opt2.compiledTrialRecords.responseTime];
...
ctr2 = filterBehaviorData(data2,'tsName','orCTRSweep');%1x1042 trials
...
ctrData.correction = [ctr1.compiledTrialRecords.correctionTrial ctr2.compiledTrialRecords.correctionTrial];
ctrData.contrast = [ctr1.compiledDetails(1).records.contrasts ctr2.compiledDetails(2).records.contrasts];
