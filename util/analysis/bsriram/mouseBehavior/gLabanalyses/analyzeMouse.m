...
if ~exist('analysisFor','var')||isempty(analysisFor)
    ...
    analyzeORLED = analysisFor.analyzeORLED;
    
    if isfield(analysisFor,'tsName')
...
if analyzeORLED
    out.ORLEDData = analyzeORLEDTrials(mouseID,data,filters,plotDetails,trialNumCutoff,daysPBS,daysCNO,daysIntact,daysLesion);    
end
