function spatFreqData = analyzeSpatFreqTrials(mouseID,data,filters,plotDetails,trialNumCutoff,daysPBS,daysCNO,daysIntact,daysLesion)
...
spat = filterBehaviorData(data,'tsName','orSFSweep_nAFC');
