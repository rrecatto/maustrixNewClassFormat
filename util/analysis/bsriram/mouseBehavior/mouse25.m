function out = mouse25(filters,plotOn,trialNumCutoff)
out = [];
...
daysLesion = {'22-Jan-2013','23-Jan-2013','24-Jan-2013','25-Jan-2013','26-Jan-2013','28-Jan-2013','29-Jan-2013','30-Jan-2013','31-Jan-2013','01-Feb-2013','02-Feb-2013',...
    '04-Feb-2013','05-Feb-2013','06-Feb-2013','07-Feb-2013','08-Feb-2013','10-Feb-2013','11-Feb-2013','12-Feb-2013','13-Feb-2013','14-Feb-2013','15-Feb-2013','16-Feb-2013',...
    '17-Feb-2013','18-Feb-2013','19-Feb-2013','20-Feb-2013','21-Feb-2013','22-Feb-2013','23-Feb-2013','24-Feb-2013','25-Feb-2013','26-Feb-2013','27-Feb-2013','28-Feb-2013',...
    '01-Mar-2013','02-Mar-2013','03-Mar-2013','04-Mar-2013','05-Mar-2013','06-Mar-2013','07-Mar-2013','08-Mar-2013','09-Mar-2013','10-Mar-2013','11-Mar-2013','12-Mar-2013',...
    '13-Mar-2013','14-Mar-2013','15-Mar-2013'};

location1 = 'C:\Users\ephys-data\Desktop\Compiled\Box2\25.compiledTrialRecords.1-25753.mat'; % orOptimal_nAFC,orORSweep,orCTRSweep,orSFSweep
...
%% +/- 45 GRATINGS
opt1 = filterBehaviorData(data1,'tsName','orOptimal_nAFC');%4743 trials
...
ctrData.correction = [ctr1.compiledDetails(1).records.correctionTrial];
...
spatData.trialNum = [spat1.compiledTrialRecords.trialNumber];
spatData.correct = [spat1.compiledTrialRecords.correct];
spatData.correction = [spat1.compiledTrialRecords.correctionTrial];
spatData.spatFreq = [spat1.compiledDetails(1).records.pixPerCycs];
spatData.time = [spat1.compiledTrialRecords.date];
