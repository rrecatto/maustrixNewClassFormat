function out = mouse23(filters,plotOn,trialNumCutoff)
out = [];
...
daysPBS = {};
daysCNO = {};
daysIntact = {'24-Jul-2012','25-Jul-2012','26-Jul-2012','27-Jul-2012','30-Jul-2012','31-Jul-2012','01-Aug-2012','02-Aug-2012','03-Aug-2012','06-Aug-2012','07-Aug-2012',...
...
daysLesion = {'22-Jan-2013','23-Jan-2013','24-Jan-2013','25-Jan-2013','26-Jan-2013','28-Jan-2013','29-Jan-2013','30-Jan-2013','31-Jan-2013','01-Feb-2013','04-Feb-2013',...
    '05-Feb-2013','06-Feb-2013','07-Feb-2013','08-Feb-2013','10-Feb-2013','11-Feb-2013','12-Feb-2013','13-Feb-2013','14-Feb-2013','15-Feb-2013','17-Feb-2013','18-Feb-2013',...
    '19-Feb-2013','20-Feb-2013','21-Feb-2013','22-Feb-2013','24-Feb-2013','25-Feb-2013','26-Feb-2013','27-Feb-2013','28-Feb-2013','01-Mar-2013','04-Mar-2013','05-Mar-2013',...
    '06-Mar-2013','07-Mar-2013','08-Mar-2013''09-Mar-2013','10-Mar-2013','11-Mar-2013','12-Mar-2013','13-Mar-2013','14-Mar-2013'};

location1 = 'C:\Users\ephys-data\Desktop\Compiled\Box1\23.compiledTrialRecords.1-20281.mat'; % orOptimal_nAFC,orORSweep,orCTRSweep,orSFSweep
location2 = 'C:\Users\ephys-data\Desktop\Compiled\Box2\23.compiledTrialRecords.1-11310.mat'; %nAFC_images,orSFSweep,orTFSweep,orCTRSweep,orORSweep
...
%% IMAGES
im = filterBehaviorData(data1,'tsName','nAFC_images');%312 trials OLD images is missing????
...
%% +/- 45 GRATINGS
opt1 = filterBehaviorData(data1,'tsName','orOptimal_nAFC');%6795 trials
opt2 = filterBehaviorData(data2,'tsName','orOptimal_nAFC');%1718 trials
trialNumMax1 = floor(data1.compiledTrialRecords.trialNumber(end));

optData.trialNum = [opt1.compiledTrialRecords.trialNumber opt2.compiledTrialRecords.trialNumber+trialNumMax1];
optData.correct = [opt1.compiledTrialRecords.correct opt2.compiledTrialRecords.correct];
optData.correction = [opt1.compiledTrialRecords.correctionTrial opt2.compiledTrialRecords.correctionTrial];
optData.time = [opt1.compiledTrialRecords.date opt2.compiledTrialRecords.date];
...
ctr1 = filterBehaviorData(data1,'tsName','orCTRSweep');%2443 trials 
ctr2 = filterBehaviorData(data2,'tsName','orCTRSweep');%3527 trials
trialNumMax1 = floor(data1.compiledTrialRecords.trialNumber(end));
ctrData.trialNum = [ctr1.compiledTrialRecords.trialNumber ctr2.compiledTrialRecords.trialNumber+trialNumMax1];
ctrData.correct = [ctr1.compiledTrialRecords.correct ctr2.compiledTrialRecords.correct];
ctrData.correction = [ctr1.compiledDetails(1).records.correctionTrial ctr2.compiledDetails(1).records.correctionTrial];
ctrData.contrast = [ctr1.compiledDetails(1).records.contrasts ctr2.compiledDetails(1).records.contrasts];
ctrData.time = [ctr1.compiledTrialRecords.date ctr2.compiledTrialRecords.date];
...
for i = 1:length(ctrData.dates)
    if ismember(ctrData.dates(i),filters.ctrFilter)
        ...
        % filter out the nans
        whichGood = ~isnan(correctThatDate) & ~isnan(correctionThatDate);
        correctThatDate = correctThatDate(whichGood);
...
%% SPAT FREQ
spat1 = filterBehaviorData(data1,'tsName','orSFSweep');%5131 trials
spat2 = filterBehaviorData(data2,'tsName','orSFSweep');%1923 trials
trialNumMax1 = data1.compiledTrialRecords.trialNumber(end);
spatData.trialNum = [spat1.compiledTrialRecords.trialNumber spat2.compiledTrialRecords.trialNumber+trialNumMax1];
spatData.correct = [spat1.compiledTrialRecords.correct spat2.compiledTrialRecords.correct];
spatData.correction = [spat1.compiledTrialRecords.correctionTrial spat2.compiledTrialRecords.correctionTrial];
spatData.spatFreq = [spat1.compiledDetails(1).records.pixPerCycs spat2.compiledDetails(1).records.pixPerCycs];
spatData.time = [spat1.compiledTrialRecords.date spat2.compiledTrialRecords.date];
...
if plotOn
    figName = sprintf('%s::VARIABLE SPAT.FREQ.',mouseID);
    f = figure('NAME',figName);
    ax1 = subplot(3,2,1); hold on;
