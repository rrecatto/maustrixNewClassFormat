...
%% 28 June 2011
%unit1
channels={1}; thrV=[-inf 0.1 1]; cellBoundary={'trialRange',[201 202]};%trf?

channels={1}; thrV=[-0.1 inf 2]; cellBoundary={'trialRange',[288 293]};%trf?
channels={1}; thrV=[-0.1 inf 2]; cellBoundary={'trialRange',[294]};%sf
