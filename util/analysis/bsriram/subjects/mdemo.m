%% 138
subjectID = 'mdemo';
standardParams = fullfile(getRatrixPath,'util','analysis','bsriram','analysisParameters','params_01_06_2011.m');
...
%unit1 BAD
% anesth 2.0
thrV = [-0.06 inf 2]; cellBoundary={'trialRange',[756]};% just stim
