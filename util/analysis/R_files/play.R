...
pth="C:/Documents and Settings/rlab/Desktop/rack1temp/classes/util/R_files/dataIn"
...
plPrior="beta",
plPriorParameters=c(3.4e+003,1.37e+004),
t1Prior="gamma",
t1PriorParameters=c(  2,  4),
t2Prior="lognormal",
t2PriorParameters=c(  1,  1),
type="weibull")
