function params=getPlotParameters(d,goods,conditionType)
%old: function params=getPlotParameters(conditionType,conditionNames)

[junk conditionNames haveData colors]=getFlankerConditionInds(d,goods,conditionType);
nm=length(conditionNames);
...
params.someConditions=1:nm;
params.conditionNames=conditionNames;
params.colors=colors;
params.smallDisplacement=([1:nm]-ceil(nm/2))/(nm*250);
params.alpha=0.05;


%old deletable duplicate code
