function out = readIntan(filename)
...
if (num_amplifier_channels > 0)
    ...
    if (data_present)
        ...
        out.t_amplifier = t_amplifier;
    end
    out.spike_triggers = spike_triggers;
end
if (num_aux_input_channels > 0)
    out.aux_input_channels = aux_input_channels;
    if (data_present)
        out.aux_input_data = aux_input_data;
        out.t_aux_input = t_aux_input;
    end
end
if (num_supply_voltage_channels > 0)
   out.supply_voltage_channels = supply_voltage_channels;
    if (data_present)
        out.supply_voltage_data = supply_voltage_data;
        out.t_supply_voltage = t_supply_voltage;
    end
end
if (num_board_adc_channels > 0)
...
if (num_board_dig_out_channels > 0)
    ...
    if (data_present)
        out.board_dig_out_data = board_dig_out_data;
        out.t_dig = t_dig;
    end
end
if (num_temp_sensor_channels > 0)
    if (data_present)
        out.temp_sensor_data = temp_sensor_data;
        out.t_temp_sensor = t_temp_sensor;
    end
end
