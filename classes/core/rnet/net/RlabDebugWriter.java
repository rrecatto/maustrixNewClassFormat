...
public class RlabDebugWriter
{
	...
	if(f.isDirectory())
	{
	    throw new IOException("RlabDebugWriter: Can't overwrite directory");
	}
	else
	{
    ...
    public synchronized static void write(String out)
    {
	write(DEFAULT_LOG_LEVEL,out);
    }

    public synchronized static void write(int level, String out)
    {
    ...
    public synchronized static void error(String out)
    {
