classdef grEstimator
    ...
    properties(Constant = true)
        allowedTypes = {'tfGratings','orGratings','cntrGratings','sfGratings','radiiGratings','annuliGratings'};
        allowedSources = {'latestSingleUnit','latestPhysAnalysis','latestDynamicValue','inputSingleUnit'};
    end
    
    methods
        function s = grEstimator(dataPath,type,dataSources,params,dateRange)
